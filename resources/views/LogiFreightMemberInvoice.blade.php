                ...
                <div class="flex justify-between p-4">
                    ...
                    <div class="w-40">
                        ...
                        foreach ($data as $info) {
                            # code...
                            $id=$info->packagedetail->package->member->id;
                        }
                        $member=$id;
                        ?>
                        @foreach($data as $info)
                        <address class="text-sm">
                            ...
                            @if($info->packagedetail->package->member->id==$id)
                            {{$info->packagedetail->package->member->fname. ' '.$info->packagedetail->package->member->fname}}
                            {{$info->packagedetail->package->member->address}}
                            {{$info->packagedetail->package->member->telephone}}
                            @break
                            @endif
                        </address>
                        @endforeach
